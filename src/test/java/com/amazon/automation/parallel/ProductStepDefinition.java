...
public class ProductStepDefinition extends DriverFactory {
	...
	public void user_is_on_application() throws Exception {
		...
		changePinTestData=jsonutil.getNestedTestDataInMap(config.readJsonFilePath(),"ChangeAddress");
		System.out.println("changePinTestData is: "+changePinTestData);
		System.out.println(changePinTestData.get("USPinCode"));
		...
		Thread.sleep(2000);
		 ...
		 ProfiletestData.put("Ben_UserID","UserID");
		 ProfiletestData.put("FirstName","Sai");
		 ProfiletestData.put("LastName","Madhuri");
